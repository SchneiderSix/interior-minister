""" @bruin
name: transformation.transform_medidas_alternativas
type: python
tags:
  - transformation
depends:
  - ingestion.ingest_tabular
description: Transform medidas_alternativas dataset to normalized Parquet
@bruin """
...
RAW_DIR = Path(__file__).resolve().parents[3] / "data" / "raw" / "tabular" / "medidas_alternativas"
OUT_PATH = Path(__file__).resolve().parents[3] / "data" / "processed" / "tabular" / "medidas_alternativas.parquet"
